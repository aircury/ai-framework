...
4. Run `frontend-clean-implementation` and save the result to `specs/features/<feature-name>/implementation-plan.md`.
5. Run `frontend-ui-generator` using `layout.md`, `experience.md`, `implementation-plan.md`, and the extracted style guide.
...
- Use `frontend-clean-implementation` to define component boundaries, state ownership, file placement, JSX structure, primitive reuse, and conditional rendering strategy before writing substantial new UI code.
...
- Do not skip `frontend-clean-implementation` for new UI or substantial frontend changes.
