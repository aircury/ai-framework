...
- Read `.localRules/framework.local.md` before architecture-sensitive work.
- If `.localRules/framework.local.md` does not contain `## Project Architecture`, use the `custom-architecture` skill to analyse the repository and write the discovered architecture section.
