...
- If multiple tools are present (e.g., ESLint and Prettier), prioritize the one that handles the relevant concern (e.g., Prettier for formatting, ESLint for logic).
