...
- Look under `specs/changes/` for active change folders
- Read `specs/features/` for canonical behavior
...
3. **Offer to capture when decisions are made**
   ...
   |--------------|------------------|
   | New requirement discovered | `specs/features/<capability>/spec.md` |
   | Requirement changed | `specs/features/<capability>/spec.md` |
...
- **Don't implement** - Never write code or implement features. Creating working artifacts is fine, writing application code is not.
